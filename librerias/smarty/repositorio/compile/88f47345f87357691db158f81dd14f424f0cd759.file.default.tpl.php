<?php /* Smarty version Smarty-3.1.11, created on 2017-03-08 11:28:48
         compiled from "templates/plantillas/layout/default.tpl" */ ?>
<?php /*%%SmartyHeaderCode:66231552758a49f6c33aca0-94452210%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '66231552758a49f6c33aca0-94452210',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.11',
  'unifunc' => 'content_58a49f6c5bd885_75603708',
  'variables' => 
  array (
    'PAGE' => 0,
    'script' => 0,
...
<?php if ($_valid && !is_callable('content_58a49f6c5bd885_75603708')) {function content_58a49f6c5bd885_75603708($_smarty_tpl) {?><!DOCTYPE html>
<html>
	<head>
	<meta charset="utf-8">
	...
	<div class="wrapper">
		<header class="main-header">
			...
			<a href="panelPrincipal" class="logo">
				...
				<span class="logo-lg"><b>NomiIEBO</b></span>
				<!-- logo for regular state and mobile devices -->
				<span class="logo-mini"><b>IEBO</b></span>
			</a>
...
img/logo.png" alt="User Image" style="background: white"/>
									<p>
										...
										<small><?php echo $_smarty_tpl->tpl_vars['PAGE']->value['usuario']->adscripcion->getNombre();?>
</small>
									</p>
								</li>
								<!-- Menu Footer-->
		...
		<aside class="main-sidebar">
			...
			<!-- sidebar menu: : style can be found in sidebar.less -->
				<ul class="sidebar-menu">
					...
					<?php }?>
					<?php if ($_smarty_tpl->tpl_vars['PAGE']->value['usuario']->getPerfil()==1){?>
					<li class="<?php if (in_array($_smarty_tpl->tpl_vars['PAGE']->value['modulo'],array('bancos','regimen'))){?>active<?php }?> treeview">
						<a href="#">
							<span>Catálogos</span> <i class="fa fa-angle-left pull-right"></i>
						</a>
						<ul class="treeview-menu">
							<li <?php if ($_smarty_tpl->tpl_vars['PAGE']->value['modulo']=='bancos'){?>class="active"<?php }?>><a href="bancos"><i class="fa fa-university" aria-hidden="true"></i> Bancos</a></li>
							<li <?php if ($_smarty_tpl->tpl_vars['PAGE']->value['modulo']=='regimen'){?>class="active"<?php }?>><a href="regimen"><i class="fa fa-file-text-o" aria-hidden="true"></i> Regimen de contratación</a></li>
							<li <?php if ($_smarty_tpl->tpl_vars['PAGE']->value['modulo']=='cuentas'){?>class="active"<?php }?>><a href="cuentas"><i class="fa fa-balance-scale" aria-hidden="true"></i> Cuentas</a></li>
						</ul>
					</li>
					<?php }?>
					<li class="<?php if (in_array($_smarty_tpl->tpl_vars['PAGE']->value['modulo'],array('nomina'))){?>active<?php }?> treeview">
						<a href="#">
							<span>Nómina</span> <i class="fa fa-angle-left pull-right"></i>
						</a>
						<ul class="treeview-menu">
							<li <?php if ($_smarty_tpl->tpl_vars['PAGE']->value['modulo']=='nomina'){?>class="active"<?php }?>><a href="nomina"><i class="fa fa-table"></i> Panel</a></li>
						</ul>
					</li>
				</ul>
			</section>
